<template>
    <div>
        ...
        <div class="main-content">
            ...
            <div class="btn">
                <div class="btn-register" @click="register(1)">注册成为用户</div>
                <div class="btn-register" @click="register(2)">注册成为管理员</div>
                <div class="go-to-login" @click="handleLogin">已有账号，点击登录</div>
            </div>
        </div>
    </div>
</template>
